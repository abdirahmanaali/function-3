...
// CODE HERE
// const postTaxPrices = prices.map(function(el){
//   return el * 1.07
// })
const postTaxPrices = prices.map(el => el * 1.07) // = prices.map(/* Provide Your Callback Here );
...
// CODE HERE
// const myStrongest = monstersInYourPocket.filter(function(el){
//   return el.CP > 200
// })
const myStrongest = monstersInYourPocket.filter(el => el.CP > 200)// = monstersInYourPocket.filter(/* Provide Your Callback Here */)
...
// CODE HERE
// const orderTotals = orders.map(function(el){
...
// CODE HERE
const bobsTotal = purchases.filter(function(el){
  return el.owner === 'Bob'
})