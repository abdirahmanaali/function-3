...
// CODE HERE
let endingWithI = cities.filter(function(city){
  return city.charAt(city.length - 1) === 'i'
})
console.log(endingWithI);
////////// PROBLEM 4 //////////
...
fruits.forEach((el) => {
  if (el.color === 'red'){
    ...
    console.log(`The fruit with index ${fruits.indexOf(el)} is neither apple or orange`);
  }
})
